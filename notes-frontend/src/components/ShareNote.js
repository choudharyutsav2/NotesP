...
const SharedNote = () => {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gray-50 flex justify-center items-center">
        <div className="loading-spinner animate-spin" style={{width: '2rem', height: '2rem'}}></div>
      </div>
    );
  }
  ...
  if (error || !note) {
    return (
      <div className="min-h-screen bg-gray-50 flex justify-center items-center" style={{flexDirection: 'column'}}>
        ...
        <div className="bg-white rounded-lg shadow-sm border">
          <div className="px-6 py-4 border-b border-gray-200">
            <div className="flex items-center justify-between">
              ...
              <Link to="/" className="btn btn-small text-gray-600 hover:text-gray-500">
